...
public interface AccountDao {
	 ...
	 * 查询用户数量
	 */
	int countAccount(JSONObject jsonObject);

	/**
	 * 查询用户列表
	 */
	List<JSONObject> listAccount(JSONObject jsonObject);
	 ...
	 * 新增用户
	 */
	int addAccount(JSONObject jsonObject);

	/**
	 * 修改用户
	 */
	int updateAccount(JSONObject jsonObject);
